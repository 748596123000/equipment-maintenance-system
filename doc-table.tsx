...
import { Eye, Trash2, FileText, FileSpreadsheet, Presentation, Image, FileType } from "lucide-react";
...
export function DocTable({ documents, onDelete, onPreview }: DocTableProps) {
  return (
    <Table>
      <TableHeader>
        <TableRow>
